...
export DATA_DIR=$1
export BERT_PREP_WORKING_DIR=$DATA_DIR
...
python3 "$DATA_DIR"/bertPrep.py --action download --dataset squad
#python3 "$DATA_DIR"/bertPrep.py --action download --dataset mrpc
...
python3 "$DATA_DIR"/bertPrep.py --action sharding --dataset books_wiki_en_corpus


# Create HDF5 files Phase 1
python3 "$DATA_DIR"/bertPrep.py --action create_hdf5_files --dataset books_wiki_en_corpus --max_seq_length 128 \
...
python3 "$DATA_DIR"/bertPrep.py --action create_hdf5_files --dataset books_wiki_en_corpus --max_seq_length 512 \
