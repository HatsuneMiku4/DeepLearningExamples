...
def main(args):
    ...
    if args.seed is not None:
        ...
        def _worker_init_fn(id_):
            np.random.seed(seed=args.seed + args.local_rank + id_)
            random.seed(args.seed + args.local_rank + id_)
    else:
        # noinspection PyUnusedLocal
        def _worker_init_fn(id_):
            pass
    ...
    if args.lr_schedule == 'step':
        ...
        raise ValueError(f'Invalid lr policy {args.lr_schedule}')
